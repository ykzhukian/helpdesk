...
<body>
    <header>
        ...
        <div id="header">
            ...
            <div id="already">Already has an account: <a href="index.php">Login</a><br />Or <a href="register_user.php">Sign up as a Client?</a></div>
            <!-- <div class="header"><img src="images/face_black.png" alt="Logo" width="45" /></div> -->
        </div>
    </header>
    <section id="content">
        <div id="vol_pic">
            <img src="images/bulb.png" alt="Logo" width="300" />
        </div>
        <div id="registration">
            <?php 
                $errors = array();
                if (isset($_POST['username']))
                {
                    ...
                    if ($errors){
                        ...
                        include 'php/vol_registration_form.inc';
                    }
                    else
                    {
                        // if no errors, insert the new user to database
                        include 'php/insert_vol_to_db.inc';
